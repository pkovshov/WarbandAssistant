...
from wa_language.LangValue import LangValue, bind_interpolation
from wa_language.LangKey import LangKey
from wa_language.LangVar import LangVar, PlayerSexVar, PLAYER_NAME_VAR
from wa_language.Binding import Binding, PlayerSex
...
def test_bind_lang_values():
    ...
    control_value = lang[LangKey("tst_control")]
...
def test():
    ...
    assert lang[LangKey("tst_greet")] == "Greetings, {sir/lady} {playername}"
